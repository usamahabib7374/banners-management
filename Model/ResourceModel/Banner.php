...
class Banner extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    public function __construct(
        ...
        $this->bannerSliderTable = $this->getTable('magedad_bannerslider_banner_slider');
    }
	 /**
    ...
    {
        $this->_init('magedad_bannerslider_banner', 'banner_id');
    }
    /**
     * @return \MageDad\BannerManagement\Model\ResourceModel\Banner
     */
    public function getSelectedBannersCollection()
    {
        if ($this->bannerCollection === "null") {
            ...
            $collection->getSelect()->join(
                ['banner_slider' => $this->getResource()->getTable('magedad_bannerslider_banner_slider')],
     ...
     * @return $this
     */
    protected function saveSliderRelation(\MageDad\BannerManagement\Model\Banner $banner)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'magedad_bannerslider_banner_after_save_sliders',
     ...
     * @return array
     */
    public function getSliderIds(\MageDad\BannerManagement\Model\Banner $banner)
    {
        $adapter = $this->getConnection();
        $select  = $adapter->select()
